...
<table style="width: 400px">
  ...
  if (creationPanier())
  {
     $nbArticles=count($_SESSION['panier']['Nompro']);
     if ($nbArticles <= 0)
     ...
     else
     {
        ...
        {
           echo "<tr>";
           echo "<td>".htmlspecialchars($_SESSION['panier']['Nompro'][$i])."</ td>";
           echo "<td><input type=\"text\" size=\"4\" name=\"q[]\" value=\"".htmlspecialchars($_SESSION['panier']['qtteProd'][$i])."\"/></td>";
           echo "<td>".htmlspecialchars($_SESSION['panier']['PrixPro'][$i])."</td>";
           echo "<td><a href=\"".htmlspecialchars("panier.php?action=suppression&l=".rawurlencode($_SESSION['panier']['Nompro'][$i]))."\">XX</a></td>";
           echo "</tr>";
        }
                ...
                <td style="width: 30%;">
                  <div class="ajt">
                    <form action="Magazin.php" method="POST">
                      <input type="text" class="invisible" name="l" value="<?php echo $enreg['NomPro']; ?>">
                      <input type="text" class="invisible" name="q" value="1">
                      <input type="text" class="invisible" name="p" value="<?php echo $enreg['PrixPro']; ?>">
                      <button type="submit" class="transparent">Ajouter au panier</button>
                    </form>
                  </div>
                </td>
              </tr>
